...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:13px;">
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			<img src = "/images/uploadFiles/<%= productVO.getFileName() %>" alt = "상품이미지"> 
		</td>
	</tr>
	...
	<tr>
		...
		<td class="ct_write01">
			<table border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td height="26"><%=productVO.getProdDetail() %></td>
				</tr>
			</table>
		</td>
	</tr>
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01"><%=productVO.getPrice() %>원</td>
	</tr>
			...
			<table border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td background="/images/ct_btnbg02.gif" class="ct_btn01" style="padding-top:3px;">
						<a href="/addPurchaseView.do?prodNo=<%= prodNo %>">구매</a>
					</td>
