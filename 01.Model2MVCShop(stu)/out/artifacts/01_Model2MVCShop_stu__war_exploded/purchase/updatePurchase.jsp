...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top: 13px;">
	...
	<tr>
		...
		<td class="ct_write01">
      		<select name="paymentOption" class="ct_input_g" style="width: 100px; height: 19px" maxLength="20">
				<option value="1" <%= purchaseVO.getPaymentOption().trim().equals("1") ? "selected":""%>>현금구매</option>
				<option value="2"<%= purchaseVO.getPaymentOption().trim().equals("2") ? "selected":""%>>신용구매</option>
    		</select>			
		</td>
	</tr>
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
		 <input type = "text" name = "receiverPhone" value = <%= purchaseVO.getBuyer().getPhone() %>
		 	class = "ct_input_g" style = "width:100px; height:19px" maxLength="20"/>
		</td>
	</tr>
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
		 <input type = "text" name = "dlvyAddr" value = <%= purchaseVO.getDlvyAddr() %>
		 	class = "ct_input_g" style = "width:100px; height:19px" maxLength="20"/>
		</td>
	</tr>
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
		 <input type = "text" name = "dlvyRequest" value = <%= purchaseVO.getDlvyRequest() %>
		 	class = "ct_input_g" style = "width:100px; height:19px" maxLength="20"/>
		</td>
	</tr>
